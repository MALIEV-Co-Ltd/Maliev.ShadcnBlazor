...
public sealed class ShadcnThemeDomainTests
{
    ...
    public void SchemaOneJsonWithoutNewSharedControlsMigratesDeterministically()
    {
        var legacy = ShadcnThemeSerializer.Serialize(CreateTheme())
            .Replace("    \"monospaceFontFamily\": \"ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace\",\n", string.Empty, StringComparison.Ordinal)
        ...
        Assert.Equal("ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace", migrated.Metrics.MonospaceFontFamily);
    ...
    public async Task DefaultProviderOutputAndMudMappingRemainUnchangedWhenThemeIsOmitted()
    {
        ...
        Assert.Equal("--shadcn-font-sans: ui-sans-serif, system-ui, sans-serif", root.GetAttribute("style"));
    ...
    public async Task TypedProviderWritesCurrentSchemePropertiesAndMapsBothMudPalettes()
    {
        ...
        Assert.Contains("--shadcn-font-mono: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace", style, StringComparison.Ordinal);
        Assert.Contains("--shadcn-typeset-font-mono: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace", style, StringComparison.Ordinal);

...
public sealed class CodeBlockTests : BunitContext
{
    ...
    public void ShowcaseStylesheetsCarryARevisionQueryForPaletteRefreshes()
    {
        ...
        Assert.Contains("_content/Maliev.ShadcnBlazor/css/shadcn-base.css?v=2.2.0", index, StringComparison.Ordinal);
        Assert.Contains("css/showcase.css?v=2.2.0", index, StringComparison.Ordinal);
        Assert.Contains("js/mock-site-overlay.js?v=2.2.0", index, StringComparison.Ordinal);
        Assert.Contains("_framework/blazor.webassembly.js?v=2.2.0", index, StringComparison.Ordinal);
    }

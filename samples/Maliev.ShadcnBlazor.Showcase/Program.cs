...
builder.Services.AddSingleton<IThemeStudioPresetCatalog, ThemeStudioPresetCatalog>();
builder.Services.AddSingleton<IThemeUseCaseRegistry, ThemeUseCaseRegistry>();
builder.Services.AddScoped<ThemeRunwayState>();
